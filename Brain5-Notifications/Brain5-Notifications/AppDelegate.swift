...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        firstAction.identifier = "FIRST_IDENTIFER"
        ...
        secondAction.identifier = "SECOND_IDENTIFER"
        ...
        thirdAction.identifier = "THIRD_IDENTIFER"
    ...
    func application(application: UIApplication, handleActionWithIdentifier identifier: String?, forLocalNotification notification: UILocalNotification, completionHandler: () -> Void) {
        if identifier == "FIRST_IDENTIFER" {
            NSNotificationCenter.defaultCenter().postNotificationName("actionFirstPressed", object: nil)
        } else if identifier == "SECOND_IDENTIFER" {
            NSNotificationCenter.defaultCenter().postNotificationName("actionSecondPressed", object: nil)
        }
